		...
		<section class="ff-section">
			...
			<article class="ff-card ff-dashboardHero ff-densityHero">
				<div class="flex flex-wrap items-start justify-between gap-4">
					<div class="max-w-4xl">
						...
						>
							Run your fundraiser like a real launch.
						</h1>
			...
			<aside class="ff-card ff-dashboardRail xl:sticky xl:top-24">
				...
				<div class="mt-5 grid gap-3">
					...
					<p class="ff-help ff-mt-2">Connect Stripe to start accepting donations instantly.</p>
				</div>
			</aside>
			</div>
		</section>
