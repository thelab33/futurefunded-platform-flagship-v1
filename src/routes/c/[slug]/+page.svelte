...
import '$lib/styles/ff.css';
  ...
  const impactChoices: ImpactChoice[] = [
    ...
    { amount: 50, label: 'Most common', note: 'Supports travel and practice costs.', featured: true },
  ...
  const sponsorTiers: SponsorTier[] = [
    ...
    },
    {
      ...
      recognition: 'Logo or business name on the sponsor wall with stronger placement and cleaner visibility.',
      cta: 'Choose Partner',
      primary: true
    },
    {
      ...
      recognition: 'Featured sponsor-wall placement and stronger recognition across the campaign surface.',
      cta: 'Choose Champion'
    },
    {
      key: 'vip',
      ...
      recognition: 'Premium placement, VIP spotlight visibility, and stronger recognition where available.',
      cta: 'Choose VIP',
      primary: true
    }
  ];
  ...
  const percent = $derived(Math.max(0, Math.min(100, Math.floor((campaign.raised / campaign.goal) * 100))));
  const remaining = $derived(Math.max(0, campaign.goal - campaign.raised));
  const nextPush = $derived(remaining >= 1500 ? 250 : remaining >= 600 ? 150 : remaining > 0 ? remaining : 100);
  ...
  function submitSponsorInterest() {
    if (!sponsorBusiness.trim() || !sponsorContact.trim() || !/\S+@\S+\.\S+/.test(sponsorEmail.trim())) {
          ...
          <div class="ff-topbar__capsuleInner ff-stack ff-gap-2">
            <div class="ff-row ff-row--between ff-ais ff-wrap ff-topbar__mainRow">
              <div class="ff-row ff-ais ff-gap-2 ff-minw-0 ff-topbar__brandCluster">
                <a class="ff-platformBrand ff-platformBrand--mark ff-nounderline" href="/platform" aria-label="FutureFunded platform">
                ...
                <a class="ff-topbarBrand ff-topbarBrand--flagship ff-nounderline" href="#home" data-ff-home="" aria-label={`${campaign.orgName} fundraiser home`}>
                  <div
                  ...
                  <span class="ff-pill ff-pill--ghost ff-topbarBrand__pill" aria-label="preview mode">
                    Preview
                  </span>
                </a>
              </div>
              ...
              <div class="ff-row ff-ais ff-gap-2 ff-wrap ff-topbar__rightCluster">
                <div class="ff-topbar__desktop-only">
                  ...
                  >
                    <nav class="ff-navPill ff-glass ff-surface ff-nav ff-nav--pill" aria-label="Primary navigation">
            ...
            <section class="ff-topbarGoal ff-glass ff-surface" data-ff-goalbar="" role="group" aria-label="Fundraising progress">
              ...
              <div class="ff-topbarGoal__progressWrap">
                ...
                <div class="ff-meter" data-ff-meter="" role="group" aria-label="Fundraising progress meter">
                  <progress class="ff-meter__progress" max="100" value={percent} data-ff-pct="" aria-label="Fundraising progress">
                    {percent}%
                  </progress>
                </div>
              </div>
      ...
      <div class="ff-container ff-hero__shell">
        <div class="ff-hero__grid">
            ...
            <article class="ff-hero__capsule ff-glass ff-surface" data-ff-animate="rise">
              <div class="ff-hero__capsuleInner">
                <header class="ff-heroHeader">
                  <div class="ff-row ff-wrap ff-ais ff-gap-2 ff-heroMeta" role="list" aria-label="Campaign highlights">
                  ...
                  <div class="ff-grid ff-grid--3 ff-gap-2 ff-mt-3 ff-heroSnapshotGrid" role="list" aria-label="Campaign snapshot">
                    ...
                    <div class="ff-proofMini ff-proofMini--hero" role="listitem">
                      ...
                      <p class="ff-help ff-muted ff-mt-1 ff-mb-0">A practical next milestone supporters can help close.</p>
                    </div>
                  </div>
                </header>

                <div class="ff-grid ff-grid--2 ff-gap-2 ff-mt-3" role="list" aria-label="Trust and sponsor proof">
          ...
          <aside class="ff-heroPanel ff-heroPanel--flagship" data-ff-hero-panel="" aria-labelledby="heroPanelTitle">
            <article class="ff-card ff-card--premium ff-card--lift ff-glass ff-pad" data-ff-animate="rise" id="checkout">
              <header class="ff-heroPanelHead">
                ...
                <p class="ff-help ff-muted ff-mt-1 ff-mb-0">
                  Choose an amount, then confirm securely in checkout. Most supporters should finish fast once payment wiring is attached.
                </p>
              </header>

              <div class="ff-grid ff-grid--2 ff-gap-2 ff-mt-3" role="group" aria-label="Quick donation amounts">
              ...
              <form
                ...
                id="donationForm"
                onsubmit={(e) => { e.preventDefault(); submitDonation(); }}
              ...
              >
                ...
                {#if checkoutStatus}
                  <div id="checkoutStatus" class="ff-alert ff-alert--info" data-ff-checkout-status="">
                    {checkoutStatus}
                  </div>
                {/if}
              </form>
    ...
    <section id="impact" class="ff-section" aria-labelledby="impactTitle">
      <div class="ff-container">
        <header class="ff-sectionhead" aria-labelledby="impactTitle">
          ...
          <h2 class="ff-h2 ff-mt-2 ff-mb-0" id="impactTitle">Support helps move the season forward.</h2>
          <p class="ff-help ff-muted ff-mt-2 ff-mb-0">
            This page supports the shared program: travel, training, tournament fees, and the real costs that keep athletes competing together.
          </p>
        </header>
    ...
    <section id="sponsors" class="ff-section" aria-labelledby="sponsorsTitle">
      <div class="ff-container">
        <header class="ff-sectionhead" aria-labelledby="sponsorsTitle">
          ...
          <p class="ff-help ff-muted ff-mt-2 ff-mb-0">
            This page gives businesses a cleaner reason to support the season through visible recognition and better placement.
          </p>
        </header>
        ...
        <div class="ff-grid ff-grid--2 ff-gap-3 ff-mt-3">
          ...
          <article class="ff-card ff-glass ff-pad">
            ...
            <p class="ff-help ff-muted ff-mt-2 ff-mb-0">
              Open sponsor interest from the same page instead of sending businesses through a messy side process.
            </p>
        ...
        <div class="ff-impactTierGrid ff-mt-3">
          {#each sponsorTiers as tier}
            <article class={`ff-impactTier ${tier.primary ? 'ff-impactTier--premium ff-impactTier--recommended' : ''}`}>
              <div class="ff-impactTier__head">
                <div class="ff-row ff-row--between ff-ais ff-wrap">
                  <p class="ff-kicker ff-m-0">{tier.label}</p>
                  <span class={`ff-pill ${tier.primary ? 'ff-pill--accent' : 'ff-pill--ghost'}`}>{tier.badge}</span>
                </div>
      ...
      <div class="ff-container">
        <div class="ff-grid ff-grid--2 ff-gap-3">
          <article class="ff-card ff-glass ff-pad">
            ...
            <h2 class="ff-h2 ff-mt-2 ff-mb-0" id="storyTitle">A season built on reps, travel, and support.</h2>
          ...
          <article class="ff-card ff-glass ff-pad">
            ...
            <div class="ff-stack ff-mt-3">
              ...
              <div class="ff-proofMini">
                ...
                <p class="ff-help ff-muted ff-mt-1 ff-mb-0">
                  Businesses can see a stronger support package instead of guessing what sponsorship means.
                </p>
              </div>
            </div>
          </article>
    ...
    <section id="faq" class="ff-section" aria-labelledby="faqTitle">
      <div class="ff-container">
        <header class="ff-sectionhead" aria-labelledby="faqTitle">
          ...
          <h2 class="ff-h2 ff-mt-2 ff-mb-0" id="faqTitle">Everything organizations usually ask before they go live.</h2>
        </header>
        ...
        <div class="ff-footerShell ff-glass">
          <div class="ff-footerGrid">
            <div class="ff-footerBrand">
              ...
              <p class="ff-help ff-muted ff-mt-2 ff-mb-0">
                This fundraiser surface is the flagship money page. Homepage stays shorter. Campaign carries the deeper conversion story.
              </p>
            </div>
  ...
  {#if sponsorOpen}
    ...
    >
      ...
      >
        ...
        <form class="ff-stack ff-mt-3" id="sponsorForm" onsubmit={(e) => { e.preventDefault(); submitSponsorInterest(); }}>
          <input
            class="ff-input"
            type="text"
          ...
          <button type="submit" class="ff-btn ff-btn--primary ff-btn--pill">Send sponsor interest</button>
